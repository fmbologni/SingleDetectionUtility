...
class RetinaNetDet(implements(IModelService)):
    ...
    def Train(self):
        os.system("../keras-retinanet/keras_retinanet/bin/train.py --no-evaluation --batch-size 16 --tensorboard-dir ../../content/drive/My\ Drive/SingleDetectionUtility/TrainingOutput --snapshot-path ../../content/drive/My\ Drive/SingleDetectionUtility/TrainingOutput/Snapshots --snapshot ../../content/drive/My\ Drive/SingleDetectionUtility/TrainingOutput/Snapshots/resnet50_pascal_03.h5 --steps 10000 pascal ../LogosVOC")
