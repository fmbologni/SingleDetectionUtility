...
class RetinaNetDet(implements(IModelService)):
    ...
    def Train(self):
        os.system("../keras-retinanet/keras_retinanet/bin/train.py --no-evaluation --batch-size 16 --tensorboard-dir ../../content/drive/My\ Drive/SingleDetectionUtility/TrainingOutput --snapshot-path ../../content/drive/My\ Drive/SingleDetectionUtility/TrainingOutput/Snapshots --snapshot ../../content/drive/My\ Drive/SingleDetectionUtility/TrainingOutput/Snapshots/resnet50_pascal_12.h5 --steps 4000 pascal ../LogosVOC")
